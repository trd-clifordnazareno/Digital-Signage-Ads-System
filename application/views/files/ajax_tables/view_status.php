         ...
         foreach($session_user_data as              $value => $key){
                        ...
                        <?php
                                             ...
                                             //end new location loop
                                                                                              ...
                                                                                              ?>
         <font color='black' size=3 style='font-family: unset;font-weight: 800; font-size:20px;'><b>NUMBER OF YOUR LOCATIONS : </b></font> <font size=3 color='red' style='font-family: unset;font-weight: 3000;'><b style='font-weight: 900; font-size: x-large;'><?php echo $num_loc - 3;    ?></b></font>
