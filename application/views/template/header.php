                ...
                <div class="navbar-right">
                    ...
                    <div class="">
                     <table>
                                                ...
                                                <td>
                                                    <?php  if($sess_usertype == "admin")  {   ?>
                                                    <!--<form action="<?php //echo site_url();   ?>/display_client_login_logs/display_client_login" method="post">
                                                    <button type="submit" class="btn bg-olive btn-block" id="logout" style="margin-top:3px; line-height:10px;">Back To Admin Page</button>
                                                    </form>-->
                                                    <?php  }   ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                    <?php  if($sess_usertype == "admin")  {   ?>
                                                    <button type="submit" class="btn bg-olive btn-block" data-toggle="modal" data-target="#create_client_account" style="margin-top:3px; line-height:10px;">Create Client Account</button>
                                                    <?php  }   ?>
