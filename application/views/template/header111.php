...
<html>
    <head>
        ...
        <!-- bootstrap 3.0.2 -->
        <link href="<?php echo site_url();   ?>js/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- font Awesome -->
        <link href="<?php echo site_url();   ?>js/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="<?php echo site_url();   ?>js/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
        <link href="<?php echo site_url();   ?>js/css/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
